    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2 space-x-reverse">
                <a href="{{ route('admin.authors.edit', $author) }}" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition duration-150 flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                    </svg>
                    ویرایش
                </a>
                <a href="{{ route('admin.authors.index') }}" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300 transition duration-150 flex items-center">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="md:col-span-1">
                            @if($author->image)
                                <img src="{{ asset('storage/' . $author->image) }}" alt="{{ $author->name }}" class="w-full h-auto rounded-lg shadow-lg mb-4">
                            @else
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="bg-gray-50 p-4 rounded-lg mt-4 mb-6">
                                <h3 class="text-lg font-semibold mb-2">زندگی‌نامه</h3>
                                <div class="prose max-w-none text-gray-700">
                                    {!! nl2br(e($author->biography ?? 'اطلاعات زندگی‌نامه موجود نیست.')) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- کتاب‌های نویسنده -->
                    <div class="mt-10">
                        <h2 class="text-2xl font-bold text-gray-900 mb-6">کتاب‌های این نویسنده</h2>
                        ...
                        @else
                            <div class="bg-gray-50 p-6 rounded-lg text-center">
                                ...
                                <p class="text-gray-600">هیچ کتابی برای این نویسنده ثبت نشده است.</p>
                            </div>
                        @endif
                    </div>
                </div>
