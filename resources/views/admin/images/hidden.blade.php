...
<div>
    <div class="header">
        ...
        <div class="menu">
            ...
            <a href="{{ route('admin.gallery.hidden') }}" class="menu-button active bg-red-500">رد شده</a>
...
<script>
    const resetImage=e=>processImageAction(e,"{{ url('admin/gallery/reset') }}/"+e,"هیچ تصویر رد شده‌ای وجود ندارد.","تصویر به حالت بررسی نشده بازگردانده شد");
</script>
</body>
</html>
