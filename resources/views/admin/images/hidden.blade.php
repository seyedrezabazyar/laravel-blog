...
<html dir="rtl">
<head>
    <title>گالری تصاویر - تصاویر رد شده</title>
    <meta charset="UTF-8">
...
<div>
    <!-- هدر و منو -->
    <div class="header">
        <h1 class="text-2xl font-bold">گالری تصاویر - تصاویر رد شده</h1>
        <div class="menu">
            ...
            <a href="{{ route('admin.gallery.hidden') }}" class="menu-button active" style="background-color: #EF4444;">رد شده</a>
                    ...
                    setTimeout(() => {
                        ...
                        if (document.querySelectorAll('#image-gallery [data-image-id]').length === 0) {
                            document.getElementById('image-gallery').innerHTML =
                                '<div class="w-full text-center py-8 bg-yellow-100 text-yellow-700"><p class="font-bold text-lg">هیچ تصویر رد شده‌ای وجود ندارد.</p></div>';
                        }
                    }, 500);
                }
            })
