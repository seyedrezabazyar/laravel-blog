...
<div>
    <div class="header">
        ...
        <div class="menu">
            ...
            <a href="{{ route('admin.gallery.missing') }}" class="menu-button active bg-yellow-500">گمشده</a>
...
<script>
    const resetImage=e=>processImageAction(e,"{{ url('admin/gallery/reset') }}/"+e,"هیچ تصویر گمشده‌ای وجود ندارد.","تصویر به حالت بررسی نشده بازگردانده شد");
</script>
</body>
</html>
