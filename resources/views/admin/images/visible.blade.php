...
<head>
    ...
    <title>گالری تصاویر تایید شده | پنل مدیریت</title>
...
<nav class="navbar">
    <div class="container">
        ...
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link active-nav" href="/admin/gallery/visible">تصاویر تایید شده</a>
            </li>
            <li class="nav-item">
...
<div class="gallery-container">
    <div class="gallery-header">
        <h1>گالری تصاویر تایید شده</h1>
        <p>مدیریت تصاویر تایید شده</p>
    </div>
    ...
    <div class="container">
        <div class="filters-container">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="filter-group">
                        <label class="filter-label">تاریخ تایید:</label>
    ...
    <div class="counter" id="imageCounter">
        تعداد تصاویر تایید شده: <span id="totalCount">0</span>
    </div>
    ...
    <div class="empty-gallery d-none" id="emptyGallery">
        <h3>هیچ تصویر تایید شده‌ای موجود نیست</h3>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function fetchImages(page) {
            ...
            let apiUrl = `/admin/api/gallery/visible?page=${page}`;
            if (filters.search) apiUrl += `&search=${encodeURIComponent(filters.search)}`;
            if (filters.date) apiUrl += `&date=${filters.date}`;
        ...
        function createImageCard(image) {
            ...
            // تاریخ تایید تصویر
            const approvedDate = image.approved_at ? new Date(image.approved_at) : null;
            const formattedDate = approvedDate ?
                `${approvedDate.toLocaleDateString('fa-IR')} ${approvedDate.toLocaleTimeString('fa-IR', {hour: '2-digit', minute:'2-digit'})}`
                : 'نامشخص';
                ...
                <div class="image-card">
                    <div class="image-container">
                        <img src="${image.raw_image_url}" class="gallery-image" alt="تصویر ${image.id}"
                            ...
                            data-approved-at="${image.approved_at || ''}"
        ...
        window.bulkManage = function(action) {
            if (confirm(`آیا از ${action === 'reject' ? 'رد کردن' : 'خارج کردن از حالت تایید'} همه تصاویر موجود در این صفحه اطمینان دارید؟`)) {
                ...
                Promise.all(requests)
                    .then(results => {
                        console.log(`${results.length} تصویر با موفقیت ${action === 'reject' ? 'رد' : 'از حالت تایید خارج'} شدند.`);
        ...
        window.openLightbox = function(imgElement) {
            ...
            const approvedAt = imgElement.dataset.approvedAt;
            ...
            lightboxInfo.innerHTML = `
                ...
                <strong>تاریخ تایید:</strong> ${formattedDate}
            `;
