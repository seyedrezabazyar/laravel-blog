                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form action="{{ route('admin.publishers.update', $publisher) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            @if($publisher->logo)
                                <div class="mt-2 mb-4">
                                    <img src="{{ asset('storage/' . $publisher->logo) }}" alt="{{ $publisher->name }}" class="h-32 w-auto object-contain rounded-lg shadow-sm">
                                    <p class="text-sm text-gray-500 mt-1">لوگوی فعلی</p>
                                </div>
                            @endif
