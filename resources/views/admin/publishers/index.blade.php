<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ url('/admin/publishers/create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition duration-150 flex items-center">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 rounded-lg overflow-hidden">
                            ...
                            @forelse($publishers as $publisher)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <a href="{{ url('/publisher/' . $publisher->slug) }}" target="_blank" class="text-blue-600 hover:text-blue-900 flex items-center">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <!-- استفاده از آدرس صریح (هاردکد) برای اطمینان از کار کردن لینک -->
                                        <a href="{{ url('/admin/publishers/' . $publisher->id . '/edit') }}" class="text-indigo-600 hover:text-indigo-900 flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">هیچ ناشری یافت نشد</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
