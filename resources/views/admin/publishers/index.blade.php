<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('admin.publishers.create') }}" class="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition duration-150 flex items-center">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 rounded-lg overflow-hidden">
                            ...
                            @forelse($publishers as $publisher)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex items-center">
                                        <a href="{{ route('admin.publishers.show', $publisher) }}" class="text-blue-600 hover:text-blue-900 ml-3 flex items-center">
                                        ...
                                        <a href="{{ route('admin.publishers.edit', $publisher) }}" class="text-indigo-600 hover:text-indigo-900 ml-3 flex items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                            </svg>
                                            ویرایش
                                        </a>
                                        <form class="inline-block" action="{{ route('admin.publishers.destroy', $publisher) }}" method="POST" onsubmit="return confirm('آیا از حذف این ناشر اطمینان دارید؟');">
                                            @csrf
                                            @method('DELETE')
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">هیچ ناشری یافت نشد</td>
                                </tr>
                            @endforelse
                            </tbody>
                        </table>
