    ...
    <div class="bg-gradient-to-r from-indigo-50 to-purple-50 py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center">
                ...
                <p class="text-gray-600">{{ $posts->total() }} مقاله در این دسته‌بندی</p>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-10 bg-white p-6 rounded-lg shadow-sm">
            ...
            <p class="text-gray-600">
                در این بخش شما می‌توانید مقالات مرتبط با {{ $category->name }} را مطالعه کنید.
                ما تلاش می‌کنیم محتوای مفید و کاربردی در این زمینه به شما ارائه دهیم.
            </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            @empty
                <div class="col-span-3 bg-white p-12 rounded-lg shadow-sm text-center">
                    ...
                    <h3 class="text-lg font-medium text-gray-900 mb-2">هیچ پستی در این دسته‌بندی یافت نشد</h3>
                    <p class="text-gray-500">به زودی مقالات جدیدی در این دسته‌بندی اضافه خواهد شد.</p>
                </div>
            @endforelse
        </div>
