        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ route('blog.category', 'education') }}" class="text-gray-400 hover:text-white transition">آموزشی</a></li>
                    <li><a href="{{ route('blog.category', 'technology') }}" class="text-gray-400 hover:text-white transition">تکنولوژی</a></li>
                    <li><a href="{{ route('blog.category', 'lifestyle') }}" class="text-gray-400 hover:text-white transition">سبک زندگی</a></li>
                </ul>
            </div>
            <div>
